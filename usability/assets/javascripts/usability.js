...
RMPlus.Usability = (function (my) {
  ...
  my.collapse_changes_for_history = function() {
    if (RMPlus.Utils.exists('Usability.settings.collapse_changes_for_history') && RMPlus.Usability.settings.collapse_changes_for_history) {
      $('#history, #history_tabs').find('.journal:has(.details)').wrap('<div class="us-collapsible collapsed">');
      $('#history, #history_tabs').find('.journal:has(.details) h4').after("<div class='us-collapse-wrapper'><a class='in_link icon us-collapser'><span class='collapsed'>" + RMPlus.Usability.expand_label + "</span><span class='expanded'>" + RMPlus.Usability.collapse_label + "</span></a></div>");
    }
  };
